...
- `enron_emails`: broad sampled gold built from 256 evenly sampled `Date:` headers plus 100 curated body-text snippets with per-message send-time context; raw mail stays external and is flattened by the downloader.
