...
# Cache full segment results for typical document paragraphs while still
# avoiding unbounded retention of arbitrarily large bodies.
SEGMENT_CACHE_CHAR_LIMIT = 4096
