...
NO_INFERENCE_CASES = [
    ...
    ("2hr", [datetime.timedelta(hours=2)]),
    ("3wk", [datetime.timedelta(days=21)]),
    ("1yr", [datetime.timedelta(days=365)]),
    ("30sec", [datetime.timedelta(seconds=30)]),
    ...
    ("March 3", [datetime.date(2018, 3, 3)]),
    ("march 3", [datetime.date(2018, 3, 3)]),
...
MATCHED_TEXT_CASES = [
    ...
    ("foo 08.07.2013 bar", [("08.07.2013", (4, 14), datetime.datetime(2013, 8, 7, 0, 0))]),
    ("foo march 3 bar", [("march 3", (4, 11), datetime.datetime(2018, 3, 3, 0, 0))]),
    (
